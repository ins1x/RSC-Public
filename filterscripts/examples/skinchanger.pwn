...
new gItemList[TOTAL_ITEMS] = {0, ...};

for(new a = 0;a < sizeof(gItemList); a++) {
	//if(a != 74) gItemList[a] = a;
}
/* 	switch(i)
	{
		case 74, 0, 1, 2, 86, 92, 99, 149, 265, 266, 267, 268, 269, 270, 271, 272: continue;
		default: gItemList[i] = i;
	} */
