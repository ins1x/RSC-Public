...
{
    SendClientMessagef(playerid, 0x33FF33AA, "Kurva %s %d %.3f", "anyбd", -1547, 2654.6542);
    SendClientMessageToAllf(0x33FF33AA, "lofasz a %s", "fьledbe");

    GameTextForPlayerf(playerid, 3000, 3, "Kis %s", "kecske");
    GameTextForAllf(3000, 3, "Kis %s", "kecske");

    SendPlayerMessageToPlayerf(playerid, playerid, "megbasztam %s %s hбtбn", "apбdat", "anyбd");
    SendPlayerMessageToAllf(playerid, "megbasztam %s %s hбtбn", "apбdat", "anyбd");
    return 1;
}
